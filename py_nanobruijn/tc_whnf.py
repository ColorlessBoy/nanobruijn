...
class TypeChecker(InferenceMixin, DefEqMixin):
    ...
    def def_eq(self, e1, e2) -> bool: ...
    def def_eq_tagged(self, e1, e2, tag) -> bool: ...
    def def_eq_inner(self, e1, e2) -> bool: ...
    def def_eq_core(self, e1, e2): ...
    def def_eq_quick_check(self, e1, e2): ...
    def def_eq_sort(self, e1, e2): ...
    def def_eq_const(self, e1, e2) -> bool: ...
    def def_eq_local(self, e1, e2) -> bool: ...
    def def_eq_proj(self, e1, e2) -> bool: ...
    def def_eq_binder_multi(self, e1, e2): ...
    def def_eq_binder_aux(self, e1, e2) -> bool: ...
    def def_eq_app(self, e1, e2) -> bool: ...
    def def_eq_nat(self, e1, e2): ...
    def spec_app_congruence(self, e1, e2): ...
    def cheap_eq(self, x, y) -> bool: ...
    ...
    def try_eta_expansion(self, x, y) -> bool: ...
